...
| A fixed 22 px cue lane | 33 px, dragged from its bottom edge to 66 px, persisted | Operator request, 2026-08-06 (LX1-d), with no drawn handle by explicit instruction. The ceiling is derived from what the editing form and the sidebar floor still need, so the reachable maximum is 33 at 720p and 66 from 1080p up |
